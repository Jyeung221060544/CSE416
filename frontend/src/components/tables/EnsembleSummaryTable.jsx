...
/**
 * Three-column table summarizing all ensembles for the current state.
 *
 * @param {{ ensembleSummary: object }} props
 */
            ...
            <div className="min-w-[280px]">
                ...
                {ensembles.map((e, i) => {
                    ...
                    return (
                        ...
                        >
                            <span className="font-bold text-sm text-brand-deep">{meta.label}</span>
