...
/**
 * Read-only summary table of VAP by racial group for the state overview.
 * Rows are not clickable — this is purely informational.
 *
 * @param {{ stateSummary: object }} props
 */
    ...
    return (
        <div className="overflow-hidden rounded-xl border border-brand-muted/25 shadow-sm">
            ...
            <div className={`grid grid-cols-[1fr_140px_100px_140px] gap-x-4 items-center px-5 py-2.5 ${TABLE_HEADER}`}>
                <span className="text-center">Racial Group</span>
                <span className="text-center">Voting Age Pop.</span>
                <span className="text-center">VAP %</span>
